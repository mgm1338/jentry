...
public class TestHashSetLong
{
    ...
    public void fullRemove()
    {
        ...
        for( int i = 0; i < TEST_SIZE; i++ )
        {
            TestCase.assertTrue( hashSet.remove( IntValueConverter.longFromInt( i + OFFSET_FROM_ZERO ) ) );
    ...
    public void assertRemoveIsNotThereFalse()
    {
        if( template ) return;
        fullRemove();
        TestCase.assertFalse( hashSet.remove( IntValueConverter.longFromInt( 1000 ) ) );
