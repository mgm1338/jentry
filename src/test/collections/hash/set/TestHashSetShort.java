...
public class TestHashSetShort
{
    ...
    public void removeFromSameBucket()
    {
        ...
        TestCase.assertEquals( Const.NO_ENTRY, hashSet.contains( IntValueConverter.shortFromInt( 0 + OFFSET_FROM_ZERO
        ) ) );
        ...
        TestCase.assertTrue( hashSet.getEntry( IntValueConverter.shortFromInt( TEST_SIZE - 1 + OFFSET_FROM_ZERO ) )
                             == Const.NO_ENTRY );
        TestCase.assertEquals( Const.NO_ENTRY, hashSet.contains( IntValueConverter.shortFromInt( TEST_SIZE - 1 +
                                                                                                 OFFSET_FROM_ZERO ) ) );
        ...
        TestCase.assertTrue( hashSet.getEntry( IntValueConverter.shortFromInt( TEST_SIZE / 2 + OFFSET_FROM_ZERO ) )
                             == Const.NO_ENTRY );
        TestCase.assertEquals( Const.NO_ENTRY, hashSet.contains( IntValueConverter.shortFromInt( TEST_SIZE / 2 +
                                                                                                 OFFSET_FROM_ZERO
        ) ) );
