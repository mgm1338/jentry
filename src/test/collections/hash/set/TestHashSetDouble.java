...
public class TestHashSetDouble
{
    ...
    public void loadTest()
    {
        ...
        {
            int j = hashSet.insert( IntValueConverter.doubleFromInt( i + OFFSET_FROM_ZERO ) );
            TestCase.assertEquals( i, j ); //compact
            TestCase.assertTrue( hashSet.contains( IntValueConverter.doubleFromInt( i + OFFSET_FROM_ZERO ) ) == i );
        }
    ...
    public void fullRemove()
    {
        ...
        for( int i = 0; i < TEST_SIZE; i++ )
        {
            TestCase.assertNotSame( hashSet.remove( IntValueConverter.doubleFromInt( i + OFFSET_FROM_ZERO ) ), Const.NO_ENTRY );
    ...
    public void assertRemoveIsNotThereFalse()
    {
        if( template ) return;
        fullRemove();
        TestCase.assertEquals( Const.NO_ENTRY, hashSet.remove( IntValueConverter.doubleFromInt( 1000 ) ) );
    ...
    public void freeListCompactNessTest()
    {
        ...
        TestCase.assertTrue( hashSet.contains( IntValueConverter.doubleFromInt( 1000 ) ) == 0 );
        TestCase.assertEquals( Const.NO_ENTRY, hashSet.contains( IntValueConverter.doubleFromInt( 0 ) ) );
    ...
    public void growFreeListTest()
    {
        ...
        for( int i = 0; i < TEST_SIZE * 4; i++ )
        {
            TestCase.assertNotSame( Const.NO_ENTRY, hashSet.remove( IntValueConverter.doubleFromInt( i + OFFSET_FROM_ZERO
            ) ) );
        }
        TestCase.assertTrue( hashSet.isEmpty() );
    ...
    public void fullCopyValidSetTest()
    {
        if( template ) return;
        loadTest();
        HashSetDouble copy = hashSet.copy( null );
    ...
    public void copyToLargerSet()
    {
        if( template ) return;
        loadTest();
        HashSetDouble copy = hashSet.copy( new HashSetDouble( 4096 ) );
        assertEquals( hashSet, copy );
    }
    ...
    public void copyFromSmaller()
    {
        if( template ) return;
        loadTest();
        HashSetDouble copy = hashSet.copy( new HashSetDouble( 1 ) );
        assertEquals( hashSet, copy );
