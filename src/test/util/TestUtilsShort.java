 ...
 */
public class TestUtilsShort
{

    protected static EqualityFunctions.EqualsShort eq = new EqualityFunctions.EqualsShort();


    public static void assertArrayContentsEqual( short[] a, short[] b )
    {
    ...
    public static void assertArrayContentsToLen( short[] a, short[] b, int len )
    {
