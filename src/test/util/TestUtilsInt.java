 ...
 */
public class TestUtilsInt
{

    protected static EqualityFunctions.EqualsInt eq = new EqualityFunctions.EqualsInt();


    public static void assertArrayContentsEqual( int[] a, int[] b )
    {
    ...
    public static void assertArrayContentsToLen( int[] a, int[] b, int len )
    {
