 ...
 */
public class TestUtilsChar
{

    protected static EqualityFunctions.EqualsChar eq = new EqualityFunctions.EqualsChar();


    public static void assertArrayContentsEqual( char[] a, char[] b )
    {
    ...
    public static void assertArrayContentsToLen( char[] a, char[] b, int len )
    {
