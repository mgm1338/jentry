...
public abstract class ArrayFactoryCharSequence
{
     ...
     * (see {@link #ensureArrayCapacity(CharSequence[],
     * int, CharSequence, GrowthStrategy)}  }, and we would like
                                                                ...
                                                                ArrayFactoryCharSequence
    {
        ...
        @Override
        public CharSequence[] ensureArrayCapacity (CharSequence[] array, int minSize,
                                            GrowthStrategy growthStrategy)
        {
            int len = array.length;
            if (minSize > len)
