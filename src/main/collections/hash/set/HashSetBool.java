 ...
 * All rights reserved.
 */
public class HashSetBool implements CollectionBool
{
     ...
     */
    protected final ArrayFactoryBool valFactory;
    protected final ArrayFactoryInt intFactory;
    protected final HashFunctions.HashFunctionBool hashFunction;
     ...
     */
    public HashSetBool (int initialSize)
    {
        this (initialSize, .75,
              ArrayFactoryBool.defaultbooleanProvider,
              ArrayFactoryInt.defaultintProvider,
              HashFunctions.hashFunctionBool,
     ...
     * @param valFactory     the factory that allocates the boolean arrays
     ...
     */
    public HashSetBool (int initialSize, double loadFactor,
                                 ArrayFactoryBool valFactory,
                                 ArrayFactoryInt intFactory,
                                 HashFunctions.HashFunctionBool hashFunction,
                                 GrowthStrategy growthStrategy)
    {
        ...
        keys = ArrayFactoryBool.defaultbooleanProvider.alloc( initialSize );
    ...
    @Override
    public int contains (boolean value)
    {
    ...
    public void clear ()
    {
        Arrays.fill (keys, 0, nextEntry,
                     DefaultValueProvider.DefaultBool.getValue ());
    }
     ...
     * @return the bucket
     */
    private int getBucket (boolean key)
    {
     ...
     */
    protected int inBucketList (int bucket, boolean key)
    {
