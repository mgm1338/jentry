...
import collections.CollectionLong;
...
public class HashSetLong implements CollectionLong
{
    ...
    protected final ArrayFactoryLong valFactory;
     ...
     * @param valFactory     the factory that allocates the long arrays
    ...
    public HashSetLong copy( HashSetLong target )
    {
        ...
        {
            target = new HashSetLong( keys.length, loadFactor, valFactory, intFactory, hashFunction,
                                               growthStrategy );
        }
