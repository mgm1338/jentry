...
import collections.CollectionChar;
...
public class HashSetChar implements CollectionChar
{
    ...
    protected final ArrayFactoryChar valFactory;
    ...
    protected final HashFunctions.HashFunctionChar hashFunction;
    ...
    protected final EqualityFunctions.EqualsChar equalityFunction = new
            EqualityFunctions.EqualsChar();
     ...
     * @param valFactory     the factory that allocates the char arrays
     ...
     * @return the bucket
     */
    private int getBucket( char key )
    {
     ...
     */
    protected int inBucketList( int bucket, char key )
    {
     ...
     */
    public HashSetChar copy( HashSetChar target )
    {
        if( target == null ) //creating a new one
        {
            target = new HashSetChar( keys.length, loadFactor, valFactory, intFactory, hashFunction,
                                               growthStrategy );
        }
