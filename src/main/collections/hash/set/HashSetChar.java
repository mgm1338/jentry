...
import collections.generic.CollectionChar;
...
public class HashSetChar implements CollectionChar
{
    ...
    protected final ArrayFactoryChar keyFactory;
     ...
     * @param keyFactory     the factory that allocates the char arrays
