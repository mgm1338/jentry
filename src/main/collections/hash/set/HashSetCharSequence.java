...
public class HashSetCharSequence implements CollectionCharSequence
{
    ...
    protected final ArrayFactoryCharSequence keyFactory;
     ...
     * @param keyFactory     the factory that allocates the CharSequence arrays
    ...
    public HashSetCharSequence( int initialSize, double loadFactor,
                                 ArrayFactoryCharSequence keyFactory,
    ...
    public HashSetCharSequence copy( HashSetCharSequence target )
    {
        ...
        {
            target = new HashSetCharSequence( keys.length, loadFactor, keyFactory, intFactory, hashFunction,
                                               growthStrategy );
        }
