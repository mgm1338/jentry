...
import collections.CollectionCharSequence;
 ...
 * All rights reserved.
 */
public class HashSetCharSequence implements CollectionCharSequence
{
    ...
    protected final ArrayFactoryCharSequence valFactory;
    protected final ArrayFactoryInt intFactory;
    protected final HashFunctions.HashFunctionCharSequence hashFunction;
    protected final GrowthStrategy growthStrategy;
    protected final EqualityFunctions.EqualsCharSequence equalityFunction = new
            EqualityFunctions.EqualsCharSequence();
     ...
     */
    public HashSetCharSequence( int initialSize )
    {
        this( initialSize, DEFAULT_LOAD_FACTOR,
              ArrayFactoryCharSequence.defaultCharSequenceProvider,
              ArrayFactoryInt.defaultIntProvider,
              HashFunctions.hashFunctionCharSequence,
     ...
     * @param valFactory     the factory that allocates the CharSequence arrays
     ...
     */
    public HashSetCharSequence( int initialSize, double loadFactor,
                                 ArrayFactoryCharSequence valFactory,
                                 ArrayFactoryInt intFactory,
                                 HashFunctions.HashFunctionCharSequence hashFunction,
                                 GrowthStrategy growthStrategy )
    {
        ...
        keys = ArrayFactoryCharSequence.defaultCharSequenceProvider.alloc( initialSize,
                                                                     IntValueConverter.CharSequenceFromInt( Const.NO_ENTRY ) );
     ...
     */
    public int getEntry( CharSequence val )
    {
     ...
     * return a value that was removed. See {@link #getEntry(CharSequence)}  above for getting a specific value.
     *
     * @param entry the entry into the set
     * @return the value
     */
    @Override
    public CharSequence get( int entry )
    {
        return keys[ entry ];
    }
    ...
    @Override
    public int insert( CharSequence key )
    {
     ...
     */
    @Override
    public boolean remove( CharSequence value )
    {
        int bucket = getBucket( value );
     ...
     * @return the bucket
     */
    private int getBucket( CharSequence key )
    {
     ...
     */
    protected int inBucketList( int bucket, CharSequence key )
    {
    ...
    public HashSetCharSequence copy()
    {

        HashSetCharSequence target = new HashSetCharSequence( ( int ) ( size / loadFactor ), loadFactor,
                                                                this.valFactory, this.intFactory, this.hashFunction,
                                                                this.growthStrategy );
        int keyLen = keys.length;
        CharSequence[] targetKeys = target.keys;
        valFactory.ensureArrayCapacity( targetKeys, keyLen, IntValueConverter.CharSequenceFromInt( Const.NO_ENTRY ),
