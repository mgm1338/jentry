...
public class HashSetByte implements CollectionByte
{
    ...
    public HashSetByte copy()
    {

        HashSetByte target = new HashSetByte( ( int ) ( size / loadFactor ), loadFactor,
                                                                this.valFactory, this.intFactory, this.hashFunction,
                                                                this.growthStrategy );
        int keyLen = keys.length;
        byte[] targetKeys = target.keys;
        valFactory.ensureArrayCapacity( targetKeys, keyLen, IntValueConverter.byteFromInt( Const.NO_ENTRY ),
