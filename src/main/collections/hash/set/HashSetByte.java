...
import collections.generic.CollectionByte;
...
public class HashSetByte implements CollectionByte
{
    ...
    protected final ArrayFactoryByte keyFactory;
     ...
     * @param keyFactory     the factory that allocates the byte arrays
