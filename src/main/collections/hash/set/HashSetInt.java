...
import collections.generic.CollectionInt;
...
public class HashSetInt implements CollectionInt
{
    ...
    protected final ArrayFactoryInt keyFactory;
     ...
     * @param keyFactory     the factory that allocates the int arrays
     ...
     */
    public HashSetInt copy( HashSetInt target )
    {
