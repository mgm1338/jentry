...
import collections.generic.CollectionFloat;
...
public class HashSetFloat implements CollectionFloat
{
    ...
    protected final ArrayFactoryFloat keyFactory;
     ...
     * @param keyFactory     the factory that allocates the float arrays
    ...
    public HashSetFloat copy( HashSetFloat target )
    {
        ...
        {
            target = new HashSetFloat( keys.length, loadFactor, keyFactory, intFactory, hashFunction,
                                               growthStrategy );
        }
