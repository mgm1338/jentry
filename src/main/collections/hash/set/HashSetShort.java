...
import collections.generic.CollectionShort;
...
public class HashSetShort implements CollectionShort
{
    ...
    protected final ArrayFactoryShort keyFactory;
     ...
     * @param keyFactory     the factory that allocates the short arrays
