...
import collections.generic.CollectionDouble;
...
public class HashSetDouble implements CollectionDouble
{
    ...
    protected final ArrayFactoryDouble keyFactory;
     ...
     * @param keyFactory     the factory that allocates the double arrays
     ...
     */
    public int getEntry( double key )
    {
     ...
     */
    public HashSetDouble copy( HashSetDouble target )
    {
