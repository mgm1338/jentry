 ...
 */
public class TestUtils_ValueTypeName_
{

    protected static EqualityFunctions.Equals_ValueTypeName_ eq = new EqualityFunctions.Equals_ValueTypeName_();


    public static void assertArrayContentsEqual( _val_[] a, _val_[] b )
    {
    ...
    public static void assertArrayContentsToLen( _val_[] a, _val_[] b, int len )
    {
