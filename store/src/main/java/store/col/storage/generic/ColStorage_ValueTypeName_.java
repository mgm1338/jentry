 ...
 * Created: 4/24/13
 */
public interface ColStorage_ValueTypeName_
{
    /**
     ...
     */
    ColStorage_ValueTypeName_ getCopy();
     ...
     */
    void copyFrom( ColStorage_ValueTypeName_ source, int srcPos, int destPos, int length );
